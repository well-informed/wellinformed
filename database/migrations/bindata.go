...
func bindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "bindata.go", size: 12288, mode: os.FileMode(420), modTime: time.Unix(1597879492, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
